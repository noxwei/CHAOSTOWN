...
**Want technical details?** → [docs/setup/ARCHITECTURE.md](docs/setup/ARCHITECTURE.md)

## 📚 Documentation Structure

### 🚀 Getting Started
- [QUICKSTART.md](QUICKSTART.md) - Get running in 10 minutes
- [docs/setup/ARCHITECTURE.md](docs/setup/ARCHITECTURE.md) - System overview
...
- [docs/operations/DISASTER_RECOVERY.md](docs/operations/DISASTER_RECOVERY.md) - Emergency protocols

### 👩‍💻 Development
- [docs/development/QA_TESTS.md](docs/development/QA_TESTS.md) - Testing framework
- [Claude.md](Claude.md) - System configuration and instructions

### 🔬 Research
- [docs/research/EXPERIMENT_DESIGN.md](docs/research/EXPERIMENT_DESIGN.md) - Scientific methodology
...
**System down?** → [docs/operations/DISASTER_RECOVERY.md](docs/operations/DISASTER_RECOVERY.md)
...
| **Research goals** | [docs/research/EXPERIMENT_DESIGN.md](docs/research/EXPERIMENT_DESIGN.md) |
